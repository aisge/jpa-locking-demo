...
Starten Sie nun 2 Aufrufe auf den gleichen Datensatz und achten Sie wieder auf die Konsolenausgabe.
...
Gesperrt werden im Normalfall jedoch nur die von der Query gelieferten Datensätze.
